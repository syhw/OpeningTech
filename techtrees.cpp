        ...
        const string& filename)
{
    ...
    file << "set ylabel \"P(TechTree)\"" << endl;
 ...
 * X = LastX value
 */
void test_same_X(plValues& x, const plValues& last_x)
{
    x[0] = last_x[0];
}
...
TechTreePredictor::TechTreePredictor(const vector<string>& op,
